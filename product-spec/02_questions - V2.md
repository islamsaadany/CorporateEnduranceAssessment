...
> Locked content. The 42 statements below are the final agreed wording. **Do not rewrite them.** Paste verbatim into code/database. Refinement requires a methodology revision.
...
|-------|------|-------------|
| `id` | string | Short identifier — `Na` (Structure) or `Nb` (Practice) where N is 1–21 |
| `pillar` | enum | `Agility` / `Toughness` / `Resilience` |
| `capability` | string | One of the 21 capability names (see `01_pillars_and_capabilities.md`) |
| `angle` | enum | `Structure` (does the mechanism exist?) or `Practice` (does it work?) |
| `text` | string | The exact statement the respondent rates 1–4 |

---

## 2. The 42 statements (verbatim)
...
[
  ...
  { "id": "6a", "pillar": "Agility", "capability": "Digital & Data Fluency", "angle": "Structure",
  ...
  { "id": "6b", "pillar": "Agility", "capability": "Digital & Data Fluency", "angle": "Practice",
    "text": "Our people use data and digital tools fluently in everyday work — they shape decisions and execution, not just reports." },

  { "id": "7a", "pillar": "Agility", "capability": "Strategic Renewal & Scenario Planning", "angle": "Structure",
    "text": "We conduct regular scenario planning and strategy reviews that prepare us for multiple possible futures." },
  { "id": "7b", "pillar": "Agility", "capability": "Strategic Renewal & Scenario Planning", "angle": "Practice",
  ...
  { "id": "8a", "pillar": "Toughness", "capability": "Crisis Leadership", "angle": "Structure",
  ...
  { "id": "14b", "pillar": "Toughness", "capability": "Cyber & Technology Resilience", "angle": "Practice",
  ...
  { "id": "19b", "pillar": "Resilience", "capability": "Reputation & Stakeholder Trust Recovery", "angle": "Practice",
  ...
  { "id": "20a", "pillar": "Resilience", "capability": "Vision Clarity & Forward Mandate", "angle": "Structure",
    "text": "We have a clear post-disruption forward direction with defined priorities, owners, and milestones." },
  { "id": "20b", "pillar": "Resilience", "capability": "Vision Clarity & Forward Mandate", "angle": "Practice",
  ...
  { "id": "21a", "pillar": "Resilience", "capability": "Workforce Recovery & Re-engagement", "angle": "Structure",
    "text": "We have defined approaches and tools to assess workforce capacity and engagement after significant disruption." },
  { "id": "21b", "pillar": "Resilience", "capability": "Workforce Recovery & Re-engagement", "angle": "Practice",
...
**All 42 questions must be answered to complete the assessment.** A valid answer is one of {1, 2, 3, 4, "I don't know"}. Respondents cannot leave a question blank.
...
### Order
Fixed order across all respondents: 1a, 1b, 2a, 2b, … 21a, 21b. Grouped by pillar (Agility 1–7b → Toughness 8–14b → Resilience 15–21b).
...
- **Active voice with positive framing.** A "4 = Strongly Agree" always means the *good* side. No reverse-coded items — they confuse respondents and complicate scoring.
- **3 × 7 symmetry.** Seven capabilities per pillar — a balanced architecture that gives each temporal stage of disruption (before / during / after) equal coverage.

---

## 7. Future revisions (v3 candidates)

These are not in v2 but are tracked here for future refinement work:
...
- **Climate & Physical Risk Resilience.** Flagged as a likely 22nd capability (Toughness) for 2027–2028 revision as climate-related disclosure frameworks (TCFD, IFRS-S2) mature into stable practice.
...
| 0.2 | 2026-05-04 | Updated to 21-capability framework (42 statements). Changes: (a) Added 6 new capabilities — Digital & Data Fluency, Strategic Renewal & Scenario Planning (moved from Resilience), Crisis Leadership and Bench Depth & Succession (split from Leadership Strength Under Pressure), Cyber & Technology Resilience, Reputation & Stakeholder Trust Recovery, Vision Clarity & Forward Mandate, Workforce Recovery & Re-engagement. (b) Renumbered question IDs in new canonical order (Agility 1–7, Toughness 8–14, Resilience 15–21). (c) Updated total counts (30 → 42), pillar groupings, and progress bar references. (d) Added 3×7 symmetry rationale to §6. |
